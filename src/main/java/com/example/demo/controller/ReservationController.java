...
public class ReservationController {
	...
	public List<String> getUnavailableTimes(@RequestParam("counselorId") String counselorId,
	...
	public List<String> getAvailableTimes(@RequestParam("counselorId") String counselorId,
			@RequestParam("date") String date) {
	...
	public ResponseEntity<?> getCounselNo(@RequestParam String counselorId, @RequestParam String start) {
		try {
