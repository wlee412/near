...
public class ProfileCompletionInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		// 2. 회원 정보 누락 여부 체크
		if (client != null) {
			boolean incomplete = isNullOrEmpty(client.getName()) || isNullOrEmpty(client.getPhone())
					|| isNullOrEmpty(client.getGender()) || client.getBirth() == null
					|| isNullOrEmpty(client.getInterest()) || isNullOrEmpty(client.getAddrBase())
					|| isNullOrEmpty(client.getAddrDetail()) || isNullOrEmpty(client.getZipcode());
