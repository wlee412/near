      ...
      <c:forEach var="q" items="${questions}">
        <div class="question-block">
          ...
          <div class="answer-options">
            <label><input type="radio" name="q_${q.QNum}" value="0" required> 전혀 아니다</label><br/>
            <label><input type="radio" name="q_${q.QNum}" value="1"> 아니다</label><br/>
            <label><input type="radio" name="q_${q.QNum}" value="2"> 보통이다</label><br/>
            <label><input type="radio" name="q_${q.QNum}" value="3"> 그렇다</label><br/>
